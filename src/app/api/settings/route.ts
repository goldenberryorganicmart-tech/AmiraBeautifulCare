  ...
  try {
    ...
    if (!settings) {
      return NextResponse.json({
        brandName: process.env.NEXT_PUBLIC_STORE_NAME || "Amira Beautiful Care",
        contact: {
        ...
        marqueeText: "Welcome to Amira Beautiful Care!",
        metaTitle: process.env.NEXT_PUBLIC_STORE_NAME || "Amira Beautiful Care",
