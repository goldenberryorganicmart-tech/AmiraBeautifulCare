  ...
  try {
    ...
    return {
      ...
      appleWebApp: {
        ...
        title: settings.brandName || "Amira Beautiful Care",
      },
      formatDetection: {
        telephone: false,
      },
      openGraph: {
        title: settings.metaTitle || settings.brandName || "Amira Beautiful Care",
        description: settings.metaDescription || settings.brandName || "Your ultimate destination for quality products.",
        url: baseUrl,
        siteName: settings.brandName || "Amira Beautiful Care",
        type: 'website',
      },
      twitter: {
