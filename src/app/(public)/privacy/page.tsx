...
export const metadata: Metadata = {
  title: 'Privacy Policy | Amira Beautiful Care',
  description: 'Learn how Amira Beautiful Care collects, uses, and protects your personal information.',
};
...
export default async function PrivacyPage() {
  ...
  const contactEmail = settings.contact?.email || "support@amirabeautifulcare.com";
