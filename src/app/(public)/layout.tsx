...
export default async function PublicLayout({ children }: { children: React.ReactNode }) {
  ...
  const marqueeText = settings?.marqueeText || 'Welcome to Amira Beautiful Care! Free shipping on orders over $500.';
  const ui = {
  ...
  return (
    <>
      {showBlocker && <SubscriptionBlocker brandName={settings?.brandName || 'Amira Beautiful Care'} />}
